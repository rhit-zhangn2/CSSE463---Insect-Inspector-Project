...
mdl = load("NN_EfficientnetB0FINAL02.mat", "nn");
mdl = mdl.nn;
gnames = load("gnames.mat", "gnames");
...
% Analyze
function [accuracy, label] = analyzeNN(mdl, xValid, yValid, gnames)
[predicted, score] = predict(mdl, xValid);
predicted = gnames(gather(predicted));
